...
def tune_building_t_offset_and_mdot_hp(building, method='4R3C', t_offset_min=-15, t_offset_max=15, t_offset_step=1.0,
    ...
    '''
    from i4b.disturbances import load_weather, get_int_gains, get_solar_gains
    ...
    INT_GAIN_PROFILE = f'{repo_filepath}i4b/data/profiles/InternalGains/ResidentialDetached.csv'
    INITIAL_TEMP = 20 # °C
