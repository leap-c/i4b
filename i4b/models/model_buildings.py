...
class Building:
    """ With the building class, a bulding model can be generated from pysical and geometrical parameters as specified in the i4b/data/buildings directory.
...
if __name__ == "__main__":
    ...
    from i4b.data.buildings.sfh_58_68_geg import sfh_58_68_geg

    # Initialize the building model
    building = sfh_58_68_geg
    bldg_model = Building(params    = building, # More example buildings can be found in i4b/data/buildings/.
