...
The parameters for buildings of different refurbishment states are provided in the /i4b/data/buildings directory. 
The disturbances profiles for different building types can be found in the /i4b/data/profiles directory.
