...
Geometrical and physical parameters that specify different buildings are available in the `/i4b/data/buildings` directory, including:
...
- internal gain profiles from `i4b/data/profiles/InternalGains/`
...
env = make_room_heat_env(
    ...
    method='4R3C',
    mdot_HP=0.25,
    internal_gain_profile='i4b/data/profiles/InternalGains/ResidentialDetached.csv',
